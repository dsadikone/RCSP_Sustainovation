                        ...
                        <asp:TableRow>
                            <asp:TableCell Width="10%">
                                <asp:Table ID="table_prev" runat="server">
                                    <asp:TableRow>
                                        <asp:TableCell>
                                            <asp:ImageButton ID="imgbtn_prev" ImageUrl="Images/sma_left_arrow.png" runat="server" OnClick="ImgBtn_Prev_Click" />
                                        </asp:TableCell>
                            ...
                            <asp:TableCell Width="10%">
                                <asp:Table ID="table_next" runat="server">
                                    <asp:TableRow>
                                        ...
                                        <asp:TableCell>
                                            <asp:ImageButton ID="imgbtn_next" ImageUrl="Images/sma_right_arrow.png" runat="server" OnClick="ImgBtn_Next_Click"/>
                                        </asp:TableCell>
                                    </asp:TableRow>
                                </asp:Table>
                            </asp:TableCell>
